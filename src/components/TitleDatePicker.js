...
class TitleDatePicker extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    const { allowFutureDates, renderComponent } = this.props
    const maxDate = allowFutureDates ? null : moment().toDate()
    return (
      <View flex={1} justifyContent="center" alignItems="center">
        <StatusBar barStyle={"light-content"} animated />
        <TouchableOpacity onPress={this.toggleModal} flex={1}>
